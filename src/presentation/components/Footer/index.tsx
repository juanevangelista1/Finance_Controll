			...
			<div className='mx-auto max-w-6xl px-4 py-6 sm:px-6'>
				<div className='flex flex-col items-center gap-4 sm:flex-row sm:justify-between'>
					...
					<p className='text-center text-sm text-dt-muted'>
						Desenvolvido com <span className='text-dt-red'>♥</span> por{' '}
						<a
							href='https://www.linkedin.com/in/juan-evangelista-developer/'
							target='_blank'
					...
					<p className='text-xs text-dt-muted/60'>© {new Date().getFullYear()} DT Money</p>
				</div>
			</div>
		</footer>
	);
